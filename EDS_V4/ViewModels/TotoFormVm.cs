...
namespace EDS_V4.ViewModels
{
    public class TotoFormVm : ViewModelBase
    {
        ...
        public int Score1A { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[0].ResultA; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[0].ResultA = value; this.RaisePropertyChanged(); } }
        public int Score1B { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[0].ResultB; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[0].ResultB = value; this.RaisePropertyChanged(); } }
        public int Score2A { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[1].ResultA; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[1].ResultA = value; this.RaisePropertyChanged(); } }
        public int Score2B { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[1].ResultB; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[1].ResultB = value; this.RaisePropertyChanged(); } }
        public int Score3A { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[2].ResultA; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[2].ResultA = value; this.RaisePropertyChanged(); } }
        public int Score3B { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[2].ResultB; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[2].ResultB = value; this.RaisePropertyChanged(); } }
        public int Score4A { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[3].ResultA; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[3].ResultA = value; this.RaisePropertyChanged(); } }
        public int Score4B { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[3].ResultB; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[3].ResultB = value; this.RaisePropertyChanged(); } }
        public int Score5A { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[4].ResultA; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[4].ResultA = value; this.RaisePropertyChanged(); } }
        public int Score5B { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[4].ResultB; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[4].ResultB = value; this.RaisePropertyChanged(); } }
        public int Score6A { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[5].ResultA; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[5].ResultA = value; this.RaisePropertyChanged(); } }
        public int Score6B { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[5].ResultB; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[5].ResultB = value; this.RaisePropertyChanged(); } }
        public int Score7A { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[6].ResultA; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[6].ResultA = value; this.RaisePropertyChanged(); } }
        public int Score7B { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[6].ResultB; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[6].ResultB = value; this.RaisePropertyChanged(); } }
        public int Score8A { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[7].ResultA; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[7].ResultA = value; this.RaisePropertyChanged(); } }
        public int Score8B { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[7].ResultB; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[7].ResultB = value; this.RaisePropertyChanged(); } }
        public int Score9A { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[8].ResultA; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[8].ResultA = value; this.RaisePropertyChanged(); } }
        public int Score9B { get => ActivePlayer.Weeks[CurrentWeek - 1].Matches[8].ResultB; set { ActivePlayer.Weeks[CurrentWeek - 1].Matches[8].ResultB = value; this.RaisePropertyChanged(); } }
        ...
        {
            Score1A = ActivePlayer.Weeks[CurrentWeek - 1].Matches[0].ResultA;
            Score1B = ActivePlayer.Weeks[CurrentWeek - 1].Matches[0].ResultB;
            Score2A = ActivePlayer.Weeks[CurrentWeek - 1].Matches[1].ResultA;
            Score2B = ActivePlayer.Weeks[CurrentWeek - 1].Matches[1].ResultB;
            Score3A = ActivePlayer.Weeks[CurrentWeek - 1].Matches[2].ResultA;
            Score3B = ActivePlayer.Weeks[CurrentWeek - 1].Matches[2].ResultB;
            Score4A = ActivePlayer.Weeks[CurrentWeek - 1].Matches[3].ResultA;
            Score4B = ActivePlayer.Weeks[CurrentWeek - 1].Matches[3].ResultB;
            Score5A = ActivePlayer.Weeks[CurrentWeek - 1].Matches[4].ResultA;
            Score5B = ActivePlayer.Weeks[CurrentWeek - 1].Matches[4].ResultB;
            Score6A = ActivePlayer.Weeks[CurrentWeek - 1].Matches[5].ResultA;
            Score6B = ActivePlayer.Weeks[CurrentWeek - 1].Matches[5].ResultB;
            Score7A = ActivePlayer.Weeks[CurrentWeek - 1].Matches[6].ResultA;
            Score7B = ActivePlayer.Weeks[CurrentWeek - 1].Matches[6].ResultB;
            Score8A = ActivePlayer.Weeks[CurrentWeek - 1].Matches[7].ResultA;
            Score8B = ActivePlayer.Weeks[CurrentWeek - 1].Matches[7].ResultB;
            Score9A = ActivePlayer.Weeks[CurrentWeek - 1].Matches[8].ResultA;
            Score9B = ActivePlayer.Weeks[CurrentWeek - 1].Matches[8].ResultB;
        }
    }
}
